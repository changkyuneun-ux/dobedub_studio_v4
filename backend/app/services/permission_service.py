...
RESOURCE_CATALOG = [
    ...
    ("ACTION", "action.manage_job_requests", "Manage Worker Requests", "jobs:manage", None, None, 191),
    ...
    ("API", "api.jobs_manage", "Job Management API", "jobs:manage", "/api/jobs/request-batches", "POST/GET", 332),
